...
class BorgBackupTests(unittest.TestCase):
    ...
    def test_backup(self):
        ...
        self.assertIsNotNone(
            re.fullmatch(
                r"Using \'.+?/BACKUPS\' as backup target\.\nLoading XML file \"\./tests/borg2\.xml\"\.\nLoading XML schema \".*?backup\.xsd\"\.\nXML file \./tests/borg2\.xml is valid\.\nParsing XML element <Element {https://github\.com/jnphilipp/backup/}source at 0x[\w\d]+> for source\.\nCommand: \"borg\" \"init\" \"--encryption\" \"repokey\" \".+?/BACKUPS/.+?/files/boot\"\nEnv: None\nCwd: None\nParsing XML element <Element {https://github\.com/jnphilipp/backup/}source at 0x[\w\d]+> for source\.\nCommand: \"borg\" \"init\" \"--encryption\" \"repokey\" \".+?/BACKUPS/.+?/files/etc\"\nEnv: None\nCwd: None\nParsing XML element <Element {https://github\.com/jnphilipp/backup/}source at 0x[\w\d]+> for source\.\nCommand: \"borg\" \"init\" \"--encryption\" \"repokey\" \".+?/BACKUPS/.+?/files/home\"\nEnv: None\nCwd: None\nParsing XML element <Element {https://github\.com/jnphilipp/backup/}source at 0x[\w\d]+> for source\.\nCommand: \"borg\" \"init\" \"--encryption\" \"repokey\" \".+?/BACKUPS/.+?/files/opt\"\nEnv: None\nCwd: None\nParsing XML element <Element {https://github\.com/jnphilipp/backup/}source at 0x[\w\d]+> for source\.\nCommand: \"borg\" \"init\" \"--encryption\" \"repokey\" \".+?/BACKUPS/.+?/files/root\"\nEnv: None\nCwd: None\nParsing XML element <Element {https://github\.com/jnphilipp/backup/}source at 0x[\w\d]+> for source\.\nCommand: \"borg\" \"init\" \"--encryption\" \"repokey\" \".+?/BACKUPS/.+?/files/srv\"\nEnv: None\nCwd: None\nParsing XML element <Element {https://github\.com/jnphilipp/backup/}source at 0x[\w\d]+> for source\.\nCommand: \"borg\" \"init\" \"--encryption\" \"repokey\" \".+?/BACKUPS/.+?/files/var\"\nEnv: None\nCwd: None\nBacking up source /boot\.\nCommand: \"borg\" \"create\" \"--verbose\" \"--list\" \"--stats\" \"--show-rc\" \"--compression\" \"zstd,11\" \"--exclude-caches\" \".+?/BACKUPS/.+?/files/boot::laptop:boot-{now}\" \"/boot\"\nEnv: None\nCwd: None\nBacking up source /etc\.\nCommand: \"borg\" \"create\" \"--verbose\" \"--list\" \"--stats\" \"--show-rc\" \"--compression\" \"zstd,11\" \"--exclude-caches\" \".+?/BACKUPS/.+?/files/etc::laptop:etc-{now}\" \"/etc\"\nEnv: None\nCwd: None\nBacking up source /home\.\nCommand: \"borg\" \"create\" \"--verbose\" \"--list\" \"--stats\" \"--show-rc\" \"--compression\" \"zstd,11\" \"--exclude-caches\" \"--exclude=\*\.pyc\" \"--exclude=\*\*/\.cache\" \"--exclude=\*\*/venv\" \"--exclude=\*\*/\.venv\" \"--exclude=\*\*/__pycache__\" \"--exclude=\*\*/\.mypy_cache\" \".+?/BACKUPS/.+?/files/home::laptop:home-{now}\" \"/home\"\nEnv: None\nCwd: None\nBacking up source /opt\.\nCommand: \"borg\" \"create\" \"--verbose\" \"--list\" \"--stats\" \"--show-rc\" \"--compression\" \"zstd,11\" \"--exclude-caches\" \".+?/BACKUPS/.+?/files/opt::laptop:opt-{now}\" \"/opt\"\nEnv: None\nCwd: None\nBacking up source /root\.\nCommand: \"borg\" \"create\" \"--verbose\" \"--list\" \"--stats\" \"--show-rc\" \"--compression\" \"zstd,11\" \"--exclude-caches\" \".+?/BACKUPS/.+?/files/root::laptop:root-{now}\" \"/root\"\nEnv: None\nCwd: None\nBacking up source /srv\.\nCommand: \"borg\" \"create\" \"--verbose\" \"--list\" \"--stats\" \"--show-rc\" \"--compression\" \"zstd,11\" \"--exclude-caches\" \".+?/BACKUPS/.+?/files/srv::laptop:srv-{now}\" \"/srv\"\nEnv: None\nCwd: None\nBacking up source /var\.\nCommand: \"borg\" \"create\" \"--verbose\" \"--list\" \"--stats\" \"--show-rc\" \"--compression\" \"zstd,11\" \"--exclude-caches\" \"--exclude=var/\*\*/logs\" \"--exclude=pp:var/cache\" \"--exclude=pp:var/crash\" \"--exclude=pp:var/log\" \"--exclude=pp:var/lock\" \"--exclude=pp:var/run\" \"--exclude=pp:var/spool\" \"--exclude=pp:var/tmp\" \"--pattern=\+var/cache/pacman\" \".+?/BACKUPS/.+?/files/var::laptop:var-{now}\" \"/var\"\nEnv: None\nCwd: None\nDry run done\.\n",
                stdout,
            )
        )
        self.assertIsNotNone(
